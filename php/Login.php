...
if (isset($_POST["txtUsuario"]) && isset($_POST["txtContrasenna"])) {
    ...
    if ($obj->cargarUsuario()) {
        print "<script>alert(\"*****Bienvenido, tipo usuario*******\");window.location='../index.php';</script>";
        return;
    }
            ...
            if ($trabajador->cargarTrabajador()) {
                print "<script>alert(\"*****Bienvenido, tipo trabajador*******\");window.location='../index.php';</script>";
                return;
            }
